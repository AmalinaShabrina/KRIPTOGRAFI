...
def encrypt_message():
    ...
    if len(key) < 12:
        messagebox.showwarning("Error", "Panjang kunci harus minimal 12 karakter.")
        return
...
key_label = tk.Label(root, text="Masukkan Kunci (min 16):")
key_label.pack()
key_input = tk.Entry(root)
key_input.pack()

# Input untuk ukuran matriks
matrix_size_label = tk.Label(root, text="Ukuran Matriks (contoh: 4 untuk 4x4):")
